...
use think\Model;
use app\admin\model\three_meetings\ThreeMeetingsUsersIdentity;
...
class UserModel extends Model
{
    ...
    public function deleteComment($id)
    {
        ...
        $where['id'] = $id;
        $where['user_id'] = $userId;
        $res = CommentModel::where($where)->update(['delete_time' => time()]);
        return $res;
    }
    ...
    public function threeMeetingsIdentity()
    {
        return $this->belongsTo(ThreeMeetingsUsersIdentity::class, 'three_meetings_identity_id', 'id');
    }
}
