 ...
 * BeautifyPic返回参数结构体
 *
 * @method string getResultImage() 获取处理后的图片 base64 数据。
 * @method void setResultImage(string $ResultImage) 设置处理后的图片 base64 数据。
...
class BeautifyPicResponse extends AbstractModel
{
    ...
    /**
     * @param string $ResultImage 处理后的图片 base64 数据。
